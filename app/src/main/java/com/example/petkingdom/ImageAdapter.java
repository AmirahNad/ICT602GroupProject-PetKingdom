...
public class ImageAdapter extends BaseAdapter {
    ...
    public ImageAdapter(List<Product> list, LayoutInflater inflater, boolean showQuantity) {
        mProductList = list;
        mInflater = inflater;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        final ImageAdapter.ViewItem item;
        ...
        if (convertView == null) {
            ...
            item = new ImageAdapter.ViewItem();
            ...
            item = (ImageAdapter.ViewItem) convertView.getTag();
        }
