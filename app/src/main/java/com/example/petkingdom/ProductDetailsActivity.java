...
public class ProductDetailsActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (productIndex >= ShoppingCartHelperM.getCatalog(getResources()).size()) {
            productIndex -= ShoppingCartHelperM.getCatalog(getResources()).size();
            catalog = ShoppingCartHelperA.getCatalog(getResources());
        } else {
